package com.example.buddychat.ui.channel
...
import com.example.buddychat.databinding.FragmentChannelBinding
...
class ChannelFragment : Fragment() {
    ...
    private fun setupUser() {
        if (client.getCurrentUser() == null){
            user = if (args.chatUser.firstName.contains("Shakir")) {
                User(
                        id = args.chatUser.userName,
                        extraData = mutableMapOf(
                                "name" to args.chatUser.firstName,
                                "country" to "Bangladesh",
                                "image" to "https://i.imgur.com/CwQitvi.jpg")
                )
            }else{
                User(
                        id = args.chatUser.userName,
            ...
            client.connectUser(
                ...
                if (result.isSuccess){
                    Log.d("Channel Fragment","User is Successfully Connecting")
                }else
